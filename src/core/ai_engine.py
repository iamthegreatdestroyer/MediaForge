    ...
    def _init_components(self):
        ...
        if Client:
            try:
                ...
                if hasattr(tags, 'models'):
                    available_models = [getattr(m, 'name', str(m)) for m in tags.models]
        ...
        if SentenceTransformer:
            try:
                ...
                # Try with SSL verification disabled for Windows compatibility
                import urllib3
                ...
                logger.info("💡 Workaround: Using offline mode. Install the model manually:")
                logger.info("   pip install sentence-transformers[onnx]")
                self.embeddings_model = None
...
["tag1", "tag2", "tag3"]"""
    ...
    def get_available_models(self) -> Dict[str, List[str]]:
        ...
        try:
            ...
            available = []
            if hasattr(tags, 'models'):
                available = [getattr(m, 'name', str(m)) for m in tags.models]
            return {
