"""ML-powered auto-tagging for media files.

This module provides AI-based automatic tagging using CLIP embeddings
for zero-shot image/video classification and content understanding.
"""
...
class AutoTagger:
    ...
    async def analyze_image(
        ...
        try:
            ...
            probs, embeddings = await loop.run_in_executor(self._executor, process_image)
    ...
    async def analyze_video_keyframe(
        ...
        try:
            ...
            cmd = [
                ...
                "-i", str(video_path), "-vframes", "1", "-q:v", "2", str(tmp_path)
            ]
