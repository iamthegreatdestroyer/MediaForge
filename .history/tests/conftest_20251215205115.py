...
@pytest.fixture
def media_factory():
    """Factory for creating MediaItem instances for testing."""
    counter = [0]
    ...
    def create(
        ...
        **kwargs
        ...
        counter[0] += 1
        return MediaItem(
            file_path=file_path or f"/test/media_{counter[0]}.mp4",
            file_hash=file_hash or f"hash_{counter[0]}",
...
def tag_factory():
    ...
    def create(
        ...
        **kwargs
        ...
        counter[0] += 1
        return Tag(
            name=name or f"tag_{counter[0]}",
            description=description or f"Test tag {counter[0]}",
            color=color,
            **kwargs
        )
...
def collection_factory():
    ...
    def create(
        ...
        **kwargs
        ...
        counter[0] += 1
        return Collection(
            name=name or f"collection_{counter[0]}",
            description=description or f"Test collection {counter[0]}",
            **kwargs
        )
